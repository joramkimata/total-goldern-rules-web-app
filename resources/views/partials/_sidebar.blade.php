    ...
    <div class="sidebar-contents">
        <ul>
            ...
            <li><a class="d-flex align-items-center" href="{{route('app.reminders')}}"><i class="mx-3 fas fa-bell"></i> <span class="sidebar_small-hide"> Reminders </span> </a></li>
                <li><a class="d-flex align-items-center" href="{{route('app.reminders')}}"><i class="mx-3 fas fa-chart-bar"></i> <span class="sidebar_small-hide"> Reports </span> </a></li>
            @endif  
            @if(auth()->user()->role_id == 2)           
            <li><a class="d-flex align-items-center" href="{{route('app.quiz.staff')}}"><i class="mx-3 fas fa-newspaper"></i> <span class="sidebar_small-hide"> My Quizzes</span> </a></li>
            @endif
