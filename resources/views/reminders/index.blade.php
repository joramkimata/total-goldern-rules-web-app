            ...
            <form id="reminderForm">
                ...
                <div class="form-group">
                    ...
                    <select name="quizId" id="quiz" class="form-control">
                        <option></option>
                        @foreach(\App\Quiz::where('is_published',1)->where('quiz_status', 'EXECUTION_STARTED')->get() as $q)
                ...
                <div class="form-group">
                    <button disabled="true" type="button" id="createReminder"
                            redirectUrl="{{route("app.reminders.refresh")}}"
                            route={{route("app.reminders")}} class="hasReminders btn btn-primary
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('body').on('change', '#quiz', function () {
                ...
                Biggo.talkToServer('{{route('quiz.checkreminders')}}', data).then(function (res) {
                    if (res.length > 0) {
