...
<form id="editQuestionFormX">
    <div style="padding: 10px" id="qnx{{$id}}">
        ...
        <textarea class="form-control" name="question" id="editXQn" style="width: 100%" rows="4">{{$q->question}}</textarea><br/>
        ...
        <div class="answers-option ml-5 ">
            ...
            @if($q->qn_photo_location != "")
                <br/>
                <img id="imgEditX" src="{{$q->qn_photo_location}}" style="width: 100%; height: 350px; display: block"/>
                <br/>
            ...
            @else
                ...
                <script src="{{url('js/biggo.js')}}"></script>
                <script type="text/javascript">
                    $(function() {
