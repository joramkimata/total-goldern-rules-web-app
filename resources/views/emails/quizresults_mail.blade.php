...
<center class="wrapper">
    ...
    <table style="background-color: #F8BB86; padding: 12px" class="main center" width="602" border="0" cellspacing="0"
           cellpadding="0">
        <tbody>
        <tr>
            <td class="column">
        ...
        <tr>
            ...
            <td class="subscription" width="300">
                <div class="logo-image">
                    <a href="https://total.co.tz" target="_blank"><img
                                src="https://totalenergies.co.tz/sites/all/themes/custom/totalenergy_theme/logo.png"
