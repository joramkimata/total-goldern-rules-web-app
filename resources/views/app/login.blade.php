...
<html lang="en">
    ...
    <body class="home">
		<div class="home-form" style="margin-top: 100px">
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active jsHeightLogin" id="nav-login" role="tabpanel" aria-labelledby="nav-login-tab">
					...
					<div class="tab-content" id="nav-tabContent" >
						<div class="tab-pane fade show active" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab" >
							...
							<form id="loginForm" action="{{route('app.dologin')}}" method="POST" onsubmit="return processLogin()">
				...
				<div class="tab-pane fade jsHeightLogin jsHeightReg" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
					<form id="registerForm" action="{{route('app.doRegister')}}" method="POST">
						...
						<button type="button" red="{{route('app.doRegister.redirect')}}" route="{{route('app.doRegister')}}" id="doRegister" class="btn btn-primary btn-block px-5 py-2 mt-4">CREATE ACCOUNT!</button>
					</form>
				</div>
			</div>
					...
					<div class="modal-content">
						...
						<form id="passwordResetDialogForm">
							...
							<div class="modal-footer">
								<button type="button" route="{{route('app.password.reset')}}" id="resetBtn" class="btn btn-primary">Reset Password</button>
							</div>
						</form>
					</div>
				</div>
        ...
        <script type="text/javascript" src="{{url('app/login.js')}}"></script>
        <script type="text/javascript">
        	$(function() {
