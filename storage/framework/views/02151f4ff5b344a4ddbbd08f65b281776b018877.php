...
<?php if(count($attempts)): ?>
    ...
    <table id="dataTable_reportx" class="table table-striped table-bordered">
        ...
        <?php $__currentLoopData = $ranks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary btn-sm viewResultx" data-toggle="modal" route="<?php echo e(url($ur)); ?>"
    ...
    <?php if($qf > 0): ?>
        <button route="<?php echo e(route('quiz.publish.results', $id)); ?>" id="publishResx" class="btn btn-success btn-sm"><i
