<?php $__env->startSection('title', 'Manage Quiz'); ?>
	...
	<div class="modal fade" id="addQuizModal" tabindex="-1" role="dialog" aria-labelledby="addQuizModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered " role="document">
			<div class="modal-content">
				...
				<form action="<?php echo e(route('quiz.store')); ?>" method="POST" id="addQuizForm" onsubmit="return processAddQuiz()">
 ...
 aria-hidden="true">
	<div class="modal-dialog modal-sm modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div style="padding:10px">
					<center>
						<img src="<?php echo e(url('images/loader.gif')); ?>" id="loaderQuizV" />
					</center>
	...
	<div class="modal fade" data-backdrop="static" data-keyboard="false" id="questionModal" tabindex="-1" role="dialog" aria-labelledby="questionModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered " role="document">
			<div class="modal-content">
				...
				<div style="padding:10px">
					<center>
						<img src="<?php echo e(url('images/loader.gif')); ?>" id="loaderQns" />
					</center>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="padding:10px">
					<center>
						<img src="<?php echo e(url('images/loader.gif')); ?>" id="loaderRep" />
					</center>
...
<script>
	$(document).ready(function () {
		...
		$('body').on('click', '#addAnswer', function() {
			 ...
			 if(answerType === ""){
			 	Biggo.showFeedBackX(addQuestionForm, 'Please select answer type first', true);
			 	return;
			 }

			 var answerBody = $('#answerBody').val();
			 if(answerBody === "") {
			 	Biggo.showFeedBackX(addQuestionForm, 'Please provide answer!', true);
			 	return;
			 }
        ...
        $('body').on('click', '#saveAndContQn', function() {
        	var qn = $('#question').val();
        	if(qn === "") {
        		Biggo.showFeedBackX(addQuestionForm, 'Please provide question body', true);
			 	return;
        	}
        	var answerType = $('#answer-type').val();
			 if(answerType === ""){
			 	...
			 	if(answerType === "single") {
			 		...
			 		if( c <= 1) {
			 			Biggo.showFeedBackX(addQuestionForm, 'Please add more answer', true);
			 			return;
			 		}
			 		if(anyChecked === false) {
			 			Biggo.showFeedBackX(addQuestionForm, 'Please provide answer before saving!', true);
			 			return;
			 		}
			 		...
			 		var formdata = $('#addQuestionForm').serializeArray();
