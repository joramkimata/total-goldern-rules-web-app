...
<div class="modal-body">
    ...
    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <fieldset class="mb-3" id="qn<?php echo e($q->id); ?>">
            <h5 class="d-flex"><span class="question-number"><?php echo e($q->qn_no < 10 ? '0'.$q->qn_no : $q->qn_no); ?>.</span>
                <span>
                ...
                <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($q->category == "single"): ?>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" id="question<?php echo e($q->id); ?>_answer_<?php echo e($a->id); ?>_single"
                                   <?php echo $checked; ?> name="customRadio_<?php echo e($a->id); ?>" class="custom-control-input">
                            <label class="custom-control-label" for="question<?php echo e($q->id); ?>_answer<?php echo e($a->id); ?>"><?php echo e($a->answer); ?>
