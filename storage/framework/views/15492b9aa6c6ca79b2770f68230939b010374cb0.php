...
<div class="row">
	<div class="col-md-6" style="background-color: white; padding: 12px">
        ...
        <hr/><br/>
        <div class="form-group">
            <button type="button" id="createReminder" route=<?php echo e(route("app.reminders")); ?> class="btn btn-primary"><i class="fa fa-bell"></i> Remind Now</button>
        </div>
		</form>
	</div>
