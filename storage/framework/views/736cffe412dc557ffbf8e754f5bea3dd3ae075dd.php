	...
	<fieldset class="mb-3" id="qn<?php echo e($q->id); ?>">
		...
		<div class="answers-option ml-5 ">
			...
			<div class="custom-control custom-checkbox">
				<input disabled="true" type="checkbox" id="question<?php echo e($q->id); ?>_answer_<?php echo e($a->id); ?>_single" <?php echo $checked; ?> name="customRadio_<?php echo e($a->id); ?>" class="custom-control-input">
			...
			?>
			<div class="custom-control custom-checkbox">
				<input type="checkbox" disabled="true" class="custom-control-input" <?php echo $checked; ?> id="question<?php echo e($q->id); ?>_answer<?php echo e($a->id); ?>">
				<label class="custom-control-label" for="question<?php echo e($q->id); ?>_answer<?php echo e($a->id); ?>"><?php echo e($a->answer); ?> - <?php echo $corrX; ?></label>
			</div>
			<?php endif; ?>
