...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card" style="padding: 15px">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <select class="form-control" id="deprtId">
                    ...
                    <?php $__currentLoopData = \App\Department::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($d->id); ?>"><?php echo e(strtoupper($d->name)); ?></option>
            ...
            <div class="col-md-3">
                ...
                <input id="year" class="form-control" value="<?php echo e(date('Y')); ?>"/>
            </div>
    ...
    <div class="card" style="padding: 15px;">
        ...
        <center>
            <img src="<?php echo e(url('images/loader.gif')); ?>" style="display: none" id="loader"/>
        </center>
    ...
    <script>
        $(function () {
            ...
            $('body').on('click', '.viewStaff', function () {
               ...
               Biggo.talkToServer('<?php echo e(route("app.reports.viewstaffs")); ?>', data).then(function (res) {
                   $('#loaderx').hide();
                   $('#staffBox').html(res);
               });
            ...
            $('body').on('click', '#fetchReport', function () {
                ...
                Biggo.talkToServer('<?php echo e(route("app.reports.fetch")); ?>', data).then(function (res) {
                    $('#loader').hide();
                    $('#reportBox').html(res)
                })
            });
