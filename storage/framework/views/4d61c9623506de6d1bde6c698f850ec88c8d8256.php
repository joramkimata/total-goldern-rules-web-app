								...
								<table id="dataTable" class="table table-striped table-bordered">
									...
									<tbody>
            							...
            							<?php
							                ...
							                $c =  [1]; //\App\Quizfeedback::where('user_id', auth()->user()->id)->where('quiz_id', $q->id)->where('seen', 1)->get();
										...
										<tr>
											...
											<td><?php echo e($ranks[auth()->user()->id]); ?>/<?php echo e(\App\User::where('role_id', 2)->count()); ?></td>
											<td><button class="btn btn-primary btn-sm viewResultx" data-toggle="modal" route="<?php echo e(route('quiz.results.seen', $q->id)); ?>" data-target="#userModalQuizResults">View Results</button></td>
										</tr>
										<?php endif; ?>
