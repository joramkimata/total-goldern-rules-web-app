            ...
            <div class="row">
                ...
                <?php if(count($quizes)): ?>
                    <?php $__currentLoopData = $quizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        //$c = \App\Quizfeedback::where('quiz_id', $q->id)->where('published', 1)->where('seen', 0)->count(); //
                        //
                        //
                        $c = \App\Quizfeedback::where('user_id', auth()->user()->id)->where('quiz_id', $q->id)->where('seen', 0)->count();
                                ...
                                <div class="card card-dashboard alert alert-success">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <div class="card-details">
                                            ...
                                            <p class="card-category m-0"><?php echo e($q->description); ?></p>
                                            <p class="card-category m-0">Questions: [<?php echo e($q->questions_no); ?>]</p>
                                            <p class="card-category m-0 text-danger">Score: [<?php echo e(myscore($q->id)); ?>

                                                /<?php echo e(ansx($q->id)); ?>]</p>
                ...
                <?php if($i == 0): ?>
                    <div class="col-md-12 alert alert-warning"><i class="fa fa-file"></i> Welcome
                        to <?php echo e(\App\HelperX::appName()); ?>!
                    </div>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="font-size: 2rem">
                                ...
                                <td>
                                    <button userid="<?php echo e($u->id); ?>" class="btn btn-danger btn-sm" id="activateSingle"><i
                                                class="fa fa-check"></i> Active User
                                    </button>
                                </td>
                            </tr>
                            <?php $i++; ?>
